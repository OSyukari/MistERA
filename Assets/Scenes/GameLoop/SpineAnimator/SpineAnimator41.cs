...
public class SpineAnimator41 : SpineAnimatorBase
{
    ...
    {
        if (loader is SpineLoaderTiny_41) yield return Initialize(manager, loader as SpineLoaderTiny_41, texturePath, atlasPath, skeletonPath, straightAlpha, idleAnimName, addonAnimName);
        else
        {
    ...
    public IEnumerator Initialize(PortraitManager.CharaPortrait_Spine manager, SpineLoaderTiny_41 loader, List<string> texturePath, string atlasPath, string skeletonPath, bool straightAlpha, string idleAnimName = "idle", string addonAnimName = "action")
    {
        bool refresh = false;
