...
public class SpineLoader_42 : SpineLoader
{
    ...
    public override IEnumerator Initialize(List<string> texturePath, string atlasPath, string skeletonPath, bool straightAlpha, string idleAnimName = "", string addonAnimName = "action")
    {
        bool refresh = false;
