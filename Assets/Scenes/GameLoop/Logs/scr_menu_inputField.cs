...
public class scr_menu_inputField : scr_Menu
{
    ...
    public Message_InputField InnerQuestion = null;
    ...
    public void InitializeWithArgs(Canvas mainCanvas, EventInstance instance, Event.EventEntry.EventEntry_InputField query, scr_panel_logs logs)
    {
        ...
        if (query.defaultFieldValue != "")
        {
            if (instance.AppendStrings.TryGetValue(query.defaultFieldValue, out var apps))
            {
                this.inputField.text = String.Join(" ", apps);
            }
            else this.inputField.text = query.defaultFieldValue;
        }
    ...
    {
        new scr_menu_inputField parent;
        public scr_SelectableText button;
        Event.EventEntry.EventEntry_Question.Options option;
        EventInstance instance;
        public bool selected = false;
        public bool commitResponse = false;
        /// <summary>
        /// Attach a custom validator, isbuttonvalid check validator, onclick apply validator
        /// </summary>
        /// <param name="parent"></param>
        public Button_OptionBtn(scr_menu_inputField parent, scr_SelectableText button, EventInstance instance, Event.EventEntry.EventEntry_Question.Options option) :base(parent)
        {
            this.parent = parent;
            this.button = button;
            ...
            this.commitResponse = !option.isDefaultCancel;
