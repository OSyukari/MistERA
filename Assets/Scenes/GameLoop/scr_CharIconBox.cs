...
public class scr_CharIconBox : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    private void Awake()
    {
        ...
        SelfBackground.color = scr_System_CentralControl.current.pref.BackgroundColor_Transparent;
    ...
    {
        if (this.chara_refID == i) nameBox.color = scr_System_CentralControl.current.pref.TextColor_toggle;
        else nameBox.color = scr_System_CentralControl.current.pref.TextColor_neutral;
    }
...
*/
    ...
    void OnDestroy()
    {
        //Debug.Log("scr_CharIconBox: OnDestroy Called!");
    ...
    public void ForceExit()
    {
        ...
        if (scr_System_CampaignManager.current.CurrentTargetRef == chara_refID && !scr_System_CampaignManager.current.displaySex) nameBox.color = scr_System_CentralControl.current.pref.TextColor_toggle;
        else nameBox.color = scr_System_CentralControl.current.pref.TextColor_neutral;
    ...
    {
        if (scr_System_CampaignManager.current.ColdLoad) return;
        chara.PortraitManager.GetValidPortrait().DrawIcon(this);
