...
public class scr_Menu_Clock : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        earlymorning = scr_System_Serializer.current.Dictionary.QueryThenParse("ui_time_quadran_earlymorning");
        morning = scr_System_Serializer.current.Dictionary.QueryThenParse("ui_time_quadran_morning");
        noon = scr_System_Serializer.current.Dictionary.QueryThenParse("ui_time_quadran_noon");
        afternoon = scr_System_Serializer.current.Dictionary.QueryThenParse("ui_time_quadran_afternoon");
        evening = scr_System_Serializer.current.Dictionary.QueryThenParse("ui_time_quadran_evening");
        lateevening = scr_System_Serializer.current.Dictionary.QueryThenParse("ui_time_quadran_lateevening");
        night = scr_System_Serializer.current.Dictionary.QueryThenParse("ui_time_quadran_night");
        midnight = scr_System_Serializer.current.Dictionary.QueryThenParse("ui_time_quadran_midnight");

        timestop = scr_System_Serializer.current.Dictionary.QueryThenParse("ui_time_special_timestop");
