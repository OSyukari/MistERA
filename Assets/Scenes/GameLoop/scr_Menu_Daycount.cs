...
public class scr_Menu_Daycount : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        text_dayCount = scr_System_Serializer.current.Dictionary.QueryThenParse("ui_calendar_dayCount");
        text_month = scr_System_Serializer.current.Dictionary.QueryThenParse("ui_calendar_month");
    ...
    private void refreshCount()
    {
        ...
        string dayofWeek = scr_System_Serializer.current.Dictionary.QueryThenParse("ui_calendar_dayOfWeek_"+currentTime.DayOfWeek);
